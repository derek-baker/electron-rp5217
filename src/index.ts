...
document.addEventListener("DOMContentLoaded", function(): void {
    ...
    const dummyValue: any = new Date().toLocaleDateString("en-US");
    ...
    let _unformatDate: Function = function(dateToUnformat: any): string {
    ...
    let viewModel: Vue = new Vue({
        ...
        methods: {
            ...
            InitModelWithValsFromMongo: function(
                ...
                this.sellerNameLastNameCompany =
                    (sellerNameLastNameCompany) ? sellerNameLastNameCompany.replace("&amp;", "&") : null;
                this.sellerNameFirstName =
                    (sellerNameFirstName) ? sellerNameFirstName.replace("&amp;", "&") : null;
                this.sellerNameLastNameCompanyTwo =
                    (sellerNameLastNameCompanyTwo) ? sellerNameLastNameCompanyTwo.replace("&amp;", "&") : null;
                this.sellerNameFirstNameTwo =
                    (sellerNameFirstNameTwo) ? sellerNameFirstNameTwo.replace("&amp;", "&") : null;
            ...
            addCommaFormatting: function(event: any){
            ...
            formatAsPhoneNumber: function(event: any){
