...
describe('Intra-App Filesystem Integration Tests', function () {
    ...
    //     };
    //     const filePath = path.resolve(__dirname, 'writtenFile.sdg');

    //     let actual;
    //     const expected = JSON.stringify(mockData);
    //     // Act
    //     // const saveFileAsync = async function(event, path, data, dialog) {
    //     //     await saveFilePromisified(event, path, data, dialog); 
    //     // };
    //     return saveFilePromisified(undefined, filePath, JSON.stringify(mockData), undefined)
    //         .then( () => { 
