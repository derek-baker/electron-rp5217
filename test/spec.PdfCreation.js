...
//         // NOTE: 
//         // I validated the file ./assets/filledPdfForTest.Expected.pdf against 
//         // ./assets/NYS_filledPdfForTest.Expected.pdf
...
//         // ./assets/filledPdfForTest.Expected.pdf. The strategy for this test is to generate 
//         // a new PDF on the fly using specific inputs
//         // (see ./assets/filledPdfForTest.Expected.pdf)
//         // ,then to convert that to a textual representation that we can diff against 
//         // ./assets/filledPdfAsTextForTest.Expected.json  
...
//         const pdfParserForFillTest = new PDFParser();
...
//             fs.writeFileSync(outputTextFileForFillTest, JSON.stringify(
//                 pdfData), { encoding: 'utf-8' }
//             );
//             actualForFillTest = fs.readFileSync(
//                 outputTextFileForFillTest, { encoding: 'utf-8' }
//             );                                              
//         }); 
